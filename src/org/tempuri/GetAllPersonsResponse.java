...
public class GetAllPersonsResponse  implements java.io.Serializable {
    private org.tempuri.Person[] getAllPersonsResult;

    public GetAllPersonsResponse() {
    }

    public GetAllPersonsResponse(
           org.tempuri.Person[] getAllPersonsResult) {
     ...
     */
    public org.tempuri.Person[] getGetAllPersonsResult() {
        return getAllPersonsResult;
    }
     ...
     */
    public void setGetAllPersonsResult(org.tempuri.Person[] getAllPersonsResult) {
        this.getAllPersonsResult = getAllPersonsResult;
    }
        ...
        _equals = true && 
            ((this.getAllPersonsResult==null && other.getGetAllPersonsResult()==null) || 
             (this.getAllPersonsResult!=null &&
              java.util.Arrays.equals(this.getAllPersonsResult, other.getGetAllPersonsResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getGetAllPersonsResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getGetAllPersonsResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getGetAllPersonsResult(), i);
                if (obj != null &&
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">GetAllPersonsResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("getAllPersonsResult");
        elemField.setXmlName(new javax.xml.namespace.QName("http://tempuri.org/", "GetAllPersonsResult"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", "Person"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://tempuri.org/", "Person"));
