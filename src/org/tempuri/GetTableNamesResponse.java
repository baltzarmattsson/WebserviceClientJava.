...
public class GetTableNamesResponse  implements java.io.Serializable {
    private java.lang.String[] getTableNamesResult;

    public GetTableNamesResponse() {
    }

    public GetTableNamesResponse(
           java.lang.String[] getTableNamesResult) {
     ...
     */
    public java.lang.String[] getGetTableNamesResult() {
        return getTableNamesResult;
    }
     ...
     */
    public void setGetTableNamesResult(java.lang.String[] getTableNamesResult) {
        this.getTableNamesResult = getTableNamesResult;
    }
        ...
        _equals = true && 
            ((this.getTableNamesResult==null && other.getGetTableNamesResult()==null) || 
             (this.getTableNamesResult!=null &&
              java.util.Arrays.equals(this.getTableNamesResult, other.getGetTableNamesResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getGetTableNamesResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getGetTableNamesResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getGetTableNamesResult(), i);
                if (obj != null &&
