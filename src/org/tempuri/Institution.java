...
public class Institution  implements java.io.Serializable {
    ...
    /**
     * Gets the name value for this Institution.
     * 
     * @return name
     */
    ...
    /**
     * Sets the name value for this Institution.
     * 
     * @param name
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", "Institution"));
